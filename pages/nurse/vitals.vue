<template>
  <div class="vitals-page">
    <div class="page-header">
      ...
      <div class="page-actions"><ClinicalPatientFinder v-model="patientId" allow-walk-in @selected="selectPatient" /></div>
    </div>
...
function selectPatient(entry: any) { if (!patients.value.some((item) => item.patient_id === entry.patient_id)) patients.value.push(entry); patientId.value = entry.patient_id }
...
<style scoped>
.vitals-page { max-width: 1280px; margin: 0 auto; }.page-actions { width:min(700px,100%); }.vitals-layout { display: grid; grid-template-columns: minmax(0, 1fr) 300px; gap: 16px; align-items: start; }.vitals-form { padding: 22px 24px; }.form-section-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; margin-bottom: 15px; }.form-section-head h2 { margin-top: 3px; font-size: 16px; }.section-kicker { color: var(--blue-600); font-size: 10px; font-weight: 800; letter-spacing: .08em; text-transform: uppercase; }.form-grid-3 { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 0 12px; }.derived-value { min-height: 36px; display: flex; align-items: center; padding: 8px 11px; border-radius: var(--radius-sm); background: var(--blue-50); color: var(--blue-700); font-size: 12px; font-weight: 700; }.form-actions { display: flex; justify-content: flex-end; gap: 10px; margin-top: 20px; padding-top: 16px; border-top: 1px solid var(--border); }.patient-context { padding: 18px; }.patient-summary { display: flex; align-items: center; gap: 11px; }.patient-summary div { display: flex; flex-direction: column; }.patient-summary b { font-size: 13.5px; }.patient-summary span { color: var(--text-500); font-size: 11px; }.context-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-top: 16px; }.context-grid div { display: flex; flex-direction: column; gap: 3px; }.context-grid small { color: var(--text-500); font-size: 10px; text-transform: uppercase; }.context-grid b { font-size: 12px; }.recent-list { display: flex; flex-direction: column; gap: 8px; margin-top: 10px; }.recent-item { padding: 10px; border: 1px solid var(--border); border-radius: 8px; }.recent-item b { font-size: 11.5px; }.recent-item p { margin: 6px 0 3px; color: var(--text-700); font-size: 11px; line-height: 1.45; }.recent-item small, .empty-copy { color: var(--text-500); font-size: 10.5px; }.empty-copy { margin-top: 12px; }
