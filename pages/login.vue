  ...
  <div class="login-wrap">
    ...
    <div class="login-form-side">
      <div class="login-card">
        ...
        <p class="muted" style="font-size:13px; margin-top:6px;">Use the email and password your clinic gave you.</p>
...
async function handleSubmit() {
  ...
  if (error) {
    errorMessage.value = error.message || 'Could not sign in — check your email and password.'
    return
  }
